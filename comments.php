...
<section id="comments" class="<?php echo ( comments_open() ) ? 'comments-area' : 'comments-area comments-closed'; ?>" aria-label="<?php echo esc_attr__( 'Post Comments', 'ipress-child' ); ?>">
			...
			if ( have_comments() ) {
				if ( 1 === $comments_number ) {
					...
					$comments_title = sprintf(
						...
						_nx( '%s comment', '%s comments', $comments_number, 'Comments title', 'ipress-child' ),
		...
		<div class="comments-content">
			...
			if ( $comment_pagination ) {
				...
				echo sprintf(
					...
					esc_attr__( 'Comments', 'ipress-child' ),
