...
class IPR_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = [
			...
			'description' 	=> __( 'iPress Widget Template', 'ipress-child' ),
...
//		get_template_part( 'path/ti/template' );
	...
	public function form( $instance ) {
		...
		$fields = apply_filters( 'ipr_widget_fields', [ 
			'field 1' => __( 'Field 1', 'ipress-child' ),
			'field 2' => __( 'Field 2', 'ipress-child' ),
			'field 3' => __( 'Field 3', 'ipress-child' ),
			'field 4' => __( 'Field 4', 'ipress-child' )
		] );

		// Widget UI form
	?>
		<p>
			<label for="<?= $this->get_field_id( 'title' ); ?>"><?= __( 'Title:', 'ipress-child' ); ?></label> 
		...
		<p>
			<input class="checkbox" type="checkbox"<?php checked( $instance['count'] ); ?> id="<?= $this->get_field_id('count'); ?>" name="<?= $this->get_field_name('count'); ?>" /> <label for="<?= $this->get_field_id('count'); ?>"><?= __('Count', 'ipress-child'); ?></label>
		</p>
