	...
	final class IPR_Woocommerce {
		...
		public function add_to_cart_text( $text, $product ) {
			...
			switch ( $product_type ) {
				...
				case 'bundle':
				case 'subscription':
					return ( $product->is_purchasable() && $product->is_in_stock() ) ? __( 'Add to basket', 'ipress-child' ) : __( 'Read more', 'ipress-child' );
				case 'variable':
				case 'variable-subscription':
					return ( $product->is_purchasable() ) ? __( 'Select options', 'ipress-child' ) : __( 'Read more', 'ipress-child' );
				case 'grouped':
					return  __( 'View products', 'ipress-child' );
				case 'external':
					return ( $product->get_button_text() ) ? $product->get_button_text() : _x( 'Buy product', 'placeholder', 'ipress-child' );
				default:
					return __( 'Read more', 'ipress-child' );
			}
