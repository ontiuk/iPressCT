		...
		public function customize_register( WP_Customize_Manager $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				[
					...
					'description' => esc_html__( 'Display or hide the store pages breadcrumbs.', 'ipress-child' ),
					'type'        => 'checkbox',
			...
			$wp_customize->add_control(
				...
				[
					'type'        => 'checkbox',
					'section'     => 'ipress_woocommerce',
					'label'       => __( 'Product Pagination', 'ipress-child' ),
					'description' => __( 'Displays next and previous links on product pages. Hover reveals product details & thumbnail.', 'ipress-child' ),
					'priority'    => 20,
				]
			);
			...
			$wp_customize->add_control(
				...
				[
					'type'        => 'checkbox',
					'section'     => 'ipress_woocommerce',
					'label'       => __( 'Product Search', 'ipress-child' ),
					'description' => __( 'Displays header product search box.', 'ipress-child' ),
					'priority'    => 30,
				]
			);
