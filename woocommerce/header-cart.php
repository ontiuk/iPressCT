...
<div class="header-cart">
	<ul class="navbar-nav">
		...
		<a href="<?php echo $account_url; ?>" class="header-account-link" title="<?php echo esc_attr__( 'View your account &amp; orders', 'ipress-child' ); ?>">
		...
		<li class="nav-item cart-nav-item">
			<!-- WC Header Cart -->
			<a href="<?php echo $cart_url; ?>" id="getHeaderCart" class="header-cart-link" title="<?php echo esc_attr__( 'View your basket', 'ipress-child' ); ?>">
