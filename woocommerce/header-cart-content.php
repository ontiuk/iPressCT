...
<?php if ( $cart_count === 0 ) : ?>
	<div class="cart-item no-items">
		<?php echo sprintf( '<h5>%s</h5>', __( 'Your basket is empty', 'ipress-child' ) ); ?>
	</div>
<?php else : ?>
		...
		<div class="cart-item">
			<div class="item-content">
				...
				<div class="item-details">
                    ...
                    <small><?php echo esc_html__( 'Quantity', 'ipress-child' ); ?>: <?php echo esc_attr( $quantity ); ?></small>
...
<?php endif; ?>
	...
	<div class="cart-total">
		<span><?php echo esc_html__( 'Total', 'ipress-child' ); ?></span>
		<strong><?php echo $cart_total; ?></strong>
	</div>
	<div class="cart-links">
        <a href="<?php echo esc_url( $cart_url ); ?>" class="button"><?php echo esc_html__( 'View basket', 'ipress-child' ); ?></a>
        <a href="<?php echo esc_url( $checkout_url ); ?>" class="button"><?php echo esc_html__( 'Checkout', 'ipress-child' ); ?></a>
	</div>
