...
?>
<nav class="ipress-product-pagination" aria-label="<?php esc_attr_e( 'More products', 'ipress-child' ); ?>">
...
<?php if ( $previous_product ) : ?>
	...
	echo sprintf(
		...
		esc_attr__( 'Display Previous Product', 'ipress-child' ),
...
<?php if ( $next_product ) : ?>
	...
	echo sprintf(
		...
		esc_attr__( 'Display Next Product', 'ipress-child' ),
