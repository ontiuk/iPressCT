...
<section class="no-results not-found">
	...
	<header class="page-header">
		<h1 class="page-title page-none"><?php esc_html_e( 'Nothing to display.', 'ipress-child' ); ?></h1>
	</header><!-- .page-header -->
			...
			<?php
				printf(
					wp_kses(
						...
						__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'ipress-child' ),
						[
							'a' => [
								'href' => [],
							],
