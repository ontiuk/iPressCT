...
if ( is_year() ) {
	$date_type = 'Year';
	$date_item = get_the_date( _x( 'Y', 'yearly archives date format', 'ipress-child' ) );
} elseif ( is_month() ) {
	$date_type = 'Month';
	$data_item = get_the_date( _x( 'F Y', 'monthly archives date format', 'ipress-child' ) );
} elseif ( is_day() ) {
	$date_type = 'Day';
	$date_item = get_the_date( _x( 'F j, Y', 'daily archives date format', 'ipress-child' ) );
}
?>
<!-- Breadcrumb -->
