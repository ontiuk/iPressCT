...
echo sprintf(
	...
	esc_attr__( 'Skip to navigation', 'ipress-child' ),
	esc_html__( 'Skip to navigation', 'ipress-child' ),
	esc_attr__( 'Skip to content', 'ipress-child' ),
	esc_html__( 'Skip to content', 'ipress-child' )
);
